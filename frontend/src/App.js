...
function App() {
  ...
  const toneStart = async () => {
    ...
    pizzViolaSampler.volume.value = -1
    ...
    frenchHornSampler.volume.value = -1
    ...
    doubleBassSampler.volume.value = 5
    await Tone.loaded();
  ...
  let dataForVisualisation = localStorage.getItem('quantisedData')

  return (
    <div className="App">
      <DataVisualiser data={dataForVisualisation} />
